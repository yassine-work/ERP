...
namespace ERP.Migrations
{
    ...
    [Migration("20260202235344_AddRecruitment")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERP.Models.Candidat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ERP.Models.Candidature", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("RetourEntretien")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("CandidatId", "JobOfferId")
                        .IsUnique();
            ...
            modelBuilder.Entity("ERP.Models.JobOffer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ERP.Models.Candidature", b =>
                {
                    b.HasOne("ERP.Models.Candidat", "Candidat")
                        .WithMany("Candidatures")
                        .HasForeignKey("CandidatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ERP.Models.JobOffer", "JobOffer")
                        .WithMany("Candidatures")
